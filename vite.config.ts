  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'oelo-vs-diy-professional-install': resolve(__dirname, 'oelo-vs-diy-professional-install.html'),
        ...
        'downspout-services': resolve(__dirname, 'downspout-services.html'),
        'seamless-gutters': resolve(__dirname, 'seamless-gutters.html'),
        'fascia-soffit-repair': resolve(__dirname, 'fascia-soffit-repair.html'),
        'same-day-gutter-service': resolve(__dirname, 'same-day-gutter-service.html'),
